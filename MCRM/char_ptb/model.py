...
class MCRMModel(nn.Module):
    def __init__(self, input_size, output_size,intermidate=89,batch=32, dropout=0, emb_dropout=0):
...
class RNNModel(nn.Module):
    ...
    def __init__(self, rnn_type, input_size,output_size,intermidate=89, batch=32,dropout=0, emb_dropout=0):
